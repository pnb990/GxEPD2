...
//
// Library: https://github.com/pnb990/GxEPD2

#ifndef _GxEPD2_266b_H_
#define _GxEPD2_266b_H_
...
class GxEPD2_266c : public GxEPD2_EPD
{
  public:
    ...
    static const GxEPD2::Panel panel = GxEPD2::Waveshare_2_65_bwr;
    ...
    // constructor
    GxEPD2_266c(int8_t cs, int8_t dc, int8_t rst, int8_t busy);
    // methods (virtual)
  ...
  private:
    ...
    void _setPartialRamArea_266c(uint8_t cmd, uint16_t x, uint16_t y, uint16_t w, uint16_t h);
    void _PowerOn();
    void _PowerOff();
    void _InitDisplay();
    void _Init_Full();
